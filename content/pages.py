...
'experience': dict(label=bi('歷年紀錄','Experience'), title=bi('演講、授課與教材紀錄｜魏得恩 Wilbur Wei','Speaking, Teaching & Courseware Records | Wilbur Wei'), description=bi('魏得恩 Wilbur Wei 的 2024–2026 演講、授課與教材紀錄，涵蓋 SEMICON Taiwan 2025、自強基金會、資安署、中華電信學院、彰化縣工業會、觀音產業園區及元智大學。','Wilbur Wei’s 2024–2026 speaking, teaching and courseware records, including SEMICON Taiwan 2025, TCFST, government training, industry associations and university engagements.')),
